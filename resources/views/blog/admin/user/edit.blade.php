                    ...
                    <form action="{{ route('blog.admin.users.update', $item->id) }}" method="POST" data-toggle="validator">
                        ...
                        <div class="box-body">
                            <div class="form-group has-feedback">
                                <label for="login"><small style="font-size: small">Логин</small></label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Подтверждение пароля">
                            </div>
                            <div class="form-group has-feedback">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <select name="role" id="role" class="form-control">
                                    ...
                                    <option value="3" @php if ($role == 'admin') echo ' selected' @endphp>Админ</option>
